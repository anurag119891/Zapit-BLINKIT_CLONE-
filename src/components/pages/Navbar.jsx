...
const Navbar = ({ showLogin, setShowLogin, user, handleLogout }) => {
    ...
    const fetchSuggestions = async () => {
      ...
      try {
        const response = await fetch(
          `https://zapit-hl9x.onrender.com/api/products?search=${searchTerm}`
        );
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      const res = await fetch("https://zapit-hl9x.onrender.com/api/user/profile", {
  ...
  return (
    <>
        ...
        <div className="toast-notification">
          <div className="toast-content">
            <div className="toast-message">
              ...
              <CheckCircle fill="#008080" color="white" size={24} />
              {toast.message}
            </div>
            <button
      ...
      <nav className="navbar">
        ...
        >
          <div className="delivery-title">Delivery in 8 minutes</div>
        ...
        <div className="search-container">
          <div className="search-box">
            ...
            <input
              type="text"
              id="se"
              placeholder="Search bread, butter"
                ...
                <div className="profile-dropdown">
                  <div className="profile-card-header">
                    ...
                    <div className="user-info">
                      ...
                      <span className="user-display-phone">
                        {user.phoneNumber}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="profile-menu-section">
                    {user?.role === "admin" && (
                      <button
                        className="menu-action-item admin-link"
                        onClick={() => {
                          navigate("/dashboard");
                          setShowProfileMenu(false);
                        }}

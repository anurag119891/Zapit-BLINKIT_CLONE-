...
const AdminProduct = () => {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        const res = await fetch("https://zapit-hl9x.onrender.com/api/category");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const url = isEditMode ? `https://zapit-hl9x.onrender.com/api/products/${productToEdit._id}` : "https://zapit-hl9x.onrender.com/api/products";
